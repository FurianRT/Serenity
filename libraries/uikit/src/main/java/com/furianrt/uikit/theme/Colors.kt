...
object Colors {
    object Primary {
        ...
        val TotalBlackGrey = Color(0xFF1F1F1F)
        ...
        val Green2 = Color(0xFF0D2C2B)
        val Green3 = Color(0xFF6F8166)
    ...
    object Accent {
        ...
        val Blue5 = Color(0xFF1FB8C1)
        val RichMulberry = Color(0xFFFF00E1)
        ...
        val Pink6 = Color(0xFFE594AB)
        val PlumWine = Color(0xFF9D4874)
    ...
    object Font {
        ...
        val YellowDark = Color(0xFFFEF24F)
        val GreenLight = Color(0xFFB0EE4F)
