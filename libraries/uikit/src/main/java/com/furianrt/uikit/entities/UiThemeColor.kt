...
enum class UiThemeColor(
    ...
    PINK_LIGHT(
        ...
        onSurface = Color.Black,
        onPrimaryContainer = Color.White,
        tertiary = Colors.Accent.LightPink.copy(alpha = 0.1f),
        outlineVariant = Colors.Accent.LightPink.copy(alpha = 0.1f),
        onTertiary = Color.Black,
        tertiaryContainer = Colors.Accent.LightPink.copy(alpha = 0.15f),
        onTertiaryContainer = Colors.Accent.LightPink.copy(alpha = 0.2f),
    ...
    PURPLE_LIGHT(
        ...
        inverseSurface = Color.White.copy(alpha = 0.15f),
