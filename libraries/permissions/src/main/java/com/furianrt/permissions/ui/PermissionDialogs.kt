...
fun LocationPermissionDialog(
    ...
    var isPlaying by remember { mutableStateOf(true) }
    val composition by rememberLottieComposition(
        LottieCompositionSpec.RawRes(R.raw.anim_location_access),
    )
    val lottieState = animateLottieCompositionAsState(
        composition = composition,
        isPlaying = isPlaying,
    ...
    ConfirmationDialog(
        hint = buildAnnotatedString {
            val title = stringResource(R.string.location_permission_message)
            val boldPartOne = stringResource(R.string.location_permission_message_bold_part_1)
            val boldPartTwo = stringResource(R.string.location_permission_message_bold_part_2)
            val boldPartOneIndex = title.indexOf(boldPartOne)
            val boldPartTwoIndex = title.indexOf(boldPartTwo)
            append(title)
            if (boldPartOneIndex != -1) {
...
fun NotificationsPermissionDialog(
    ...
    var isPlaying by remember { mutableStateOf(true) }
    val composition by rememberLottieComposition(
        LottieCompositionSpec.RawRes(R.raw.anim_notifications_access),
    )
    val lottieState = animateLottieCompositionAsState(
        composition = composition,
        isPlaying = isPlaying,
    ...
    ConfirmationDialog(
        hint = buildAnnotatedString {
            val title = stringResource(R.string.notifications_permission_message)
            val boldPartOne = stringResource(R.string.notifications_permission_message_bold_part_1)
            val boldPartTwo = stringResource(R.string.notifications_permission_message_bold_part_2)
            val boldPartOneIndex = title.indexOf(boldPartOne)
            val boldPartTwoIndex = title.indexOf(boldPartTwo)
            append(title)
            if (boldPartOneIndex != -1) {
        ...
        cancelButton = {
            ActionButton(
                title = stringResource(uiR.string.action_not_now),
                onClick = onDismissRequest,
            )
        },
        confirmButton = {
...
@Preview
@Composable
private fun NotificationsPermissionDialogPreview() {
    SerenityTheme {
