...
@Composable
internal fun ConfirmRestoreDialog(
    hazeState: HazeState,
    ...
    ConfirmationDialog(
        ...
        title = AnnotatedString(stringResource(R.string.restore_warning_title)),
        hint = AnnotatedString(stringResource(R.string.restore_warning_body)),
        hazeState = hazeState,
